...
Version: 0.1.0
Authors@R: c(
    person("Daphne", "Tsoucas", email = "dtsoucas@gmail.com", role = "aut"),
...
Depends: R (>= 3.5.0)
Imports: quadprog, reshape, Seurat, ROCR , varhandle, MAST, dplyr,
        stats, utils, e1071, SummarizedExperiment, devtools
License: GPL-2
Encoding: UTF-8
Language: en-US
LazyData: true
...
Built: R 4.0.5; ; 2021-11-03 17:26:11 UTC; unix```
